...
DEFAULT_LIMIT = 100
# self-hosted (static/img/w.png): the Commons thumb URL this used to point at
# started returning HTTP 400 and broke every missing/filtered cover
DEFAULT_IMAGE = 'https://top.hatnote.com/img/w.png'
